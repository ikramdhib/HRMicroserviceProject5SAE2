...
public class Department implements Serializable {
    ...
    // Relationship one-to-many with the User entity (many users in one department)
    @OneToMany(mappedBy = "department", cascade = CascadeType.ALL)
    @JsonIgnore
    private List<Utilisateur> utilisateurs; // Ensure this references the correct field in Utilisateur
}
